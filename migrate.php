    ...
    $queries = [
        ...
        'viagens' => "
            CREATE TABLE viagens (
                ...
                CONSTRAINT chk_viagens_direcao CHECK (direcao IN ('ida', 'volta')),
                CONSTRAINT unq_viagem_linha_data_direcao UNIQUE (linha_id, data_viagem, direcao),
    ...
    $queries = [
        ...
        'viagens' => "
            CREATE TABLE viagens (
                ...
                motorista_id INT NOT NULL,
                veiculo_id INT NOT NULL,
                direcao VARCHAR(10) NOT NULL CHECK (direcao IN ('ida', 'volta')),
                status VARCHAR(50) DEFAULT 'aguardando',
                data_viagem DATE NOT NULL,
